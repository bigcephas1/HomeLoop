...
export default function UserFavoritesPage() {
  ...
  const removeFavorite = async (favorite) => {
    // Get the property ID from the favorite
    const propertyId = favorite.property?._id || favorite.property;
    ...
    try {
      // Try deleting using property ID
      ...
      {favorites.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {favorites.map((favorite) => {
            ...
            return (
              <div key={favorite._id || propertyId} className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
